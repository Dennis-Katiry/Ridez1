...
const UserProfile = () => {
  ...
  useEffect(() => {
    const fetchRides = async () => {
      setLoading(true);
      try {
        const token = localStorage.getItem("userToken"); // Updated to 'userToken'
        if (!token) {
  ...
  const handleLogout = () => {
    try {
      localStorage.removeItem("userToken"); // Updated to 'userToken'
      setUser(null);
                  ...
                  {rides.slice(0, 5).map((ride) => (
                    ...
                    >
                      ...
                      <p className="text-gray-700">
                        <i className="mr-3 text-blue-500 ri-user-line"></i>
