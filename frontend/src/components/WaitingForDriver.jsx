...
const WaitingForDriver = ({ setWaitingForDriver, ride, vehicleType }) => {
  ...
  useEffect(() => {
    ...
    console.log('Vehicle Type in WaitingForDriver:', vehicleType); // Debug log
    ...
    socket.on('ride-accepted', (data) => {
      if (data.rideId === ride._id) {
        console.log('Ride accepted, navigating to /riding with vehicleType:', vehicleType);
        setWaitingForDriver(false);
